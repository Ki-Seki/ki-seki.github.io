...
<head>
    ...
    <title>ki-seki.site</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
    <style>
        body {
            background-image: url(https://img.imgdb.cn/item/601abdb73ffa7d37b30db33c.jpg);
            width: 350px;
            text-align: center;
            margin: auto;
            margin-top: 100px;
        ...
        #footer {
            ...
            bottom: 30px;
            text-align: center;
            text-shadow: 0 0 40px rgb(255, 183, 0);
            display: inline-block;
            padding: 3px 10px;
            border-radius: 6px;
            border: 1px solid white;
            left: calc(50% - 33.25px);  /* 需根据最终大小调整数据 */
        }
...
<body>
    <div id="content" class="animate__animated animate__jello">
        <div id="counter">
            <div id="number"> Error. </div>
            <div id="suffix"> Error. </div>
        </div>
        <div id="subtitle">
            day since Ms Cui & Mr Song fell in love on <br>
            August 4, 2021.
        </div>
    </div>
    <div id="footer" class="animate__animated animate__jello">
        <a href="https://github.com/Ki-Seki/ki-seki.site"> More </a>
    </div>
    <script>
        // 运行天数
        ...
        function getRunningDays() {
            var start = new Date(2022, 8 - 1, 4).getTime();
            var end = Date.now();
